  ...
  const handleAddGalleryImages = async (existingGallery) => {
    ...
    try {
      const response = await fetch(
        "https://image-upload.getmycollege.com/addCollegeGallery",
        {
          method: "POST",
          body: formData,
        }
      ...
      if (response.ok) {
        ...
        const galleryUrls = responseData.galleryUrls || [];
            ...
            >
              <Grid item md={11} sx={11}>
                ...
                >
                  ...
                  >
                    {[...userData.gallery, ...galleryImages].map(
                      (image, index) => (
                        <img
                          key={index}
                          src={
                            typeof image.image_url === "string"
                              ? image.image_url
                              : URL.createObjectURL(image.image_url)
                          }
