...
const UpdateCollegeCourse = () => {
  ...
  const [courseList, setCourseList] = useState(userData.collegeCourse);
            ...
            >
              {index === 0 ? (
                <Grid item md={12} xs={11}>
                  <Grid sx={{ mx:isMobileScreen?1: 10 }}>
                    <FormControlLabel
                      control={
                        <Checkbox
              ...
              {course.collegeDepartment !== null || showDepartment ? (
                <Grid item md={2} xs={11}>
                  ...
                  fullWidth
                    ...
                    onChange={(event) =>
                      handleChangeCourse(event, index, "collegeDepartment")
                    }
                    inputProps={{
                      style: {
              ...
              <Grid item md={3} xs={11}>
                ...
                <Autocomplete
                  options={courseData.map((option) => option.course)}
...
export default UpdateCollegeCourse;
