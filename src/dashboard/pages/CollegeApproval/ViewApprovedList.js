  ...
  const handleApprove = async () => {
    ...
    try {
      const response = await invokeApi(
        config.getMyCollege + apiList.approveCollege,
        params,
        cookies
      );
      ...
      if (response?.status >= 200 && response?.status < 300) {
        if (response.data.responseCode === "200") {
          navigate(`/college-approval/approved-college-list`);
        } else {
                ...
                <Grid sx={{ py: isMobileScreen ? 2 : 2 }}>
                      ...
                      <Grid item md={2} xs={11}>
                        ...
                        <Grid sx={{ width: "50%", height: "50%", my: 3 }}>
                          <img
                            ...
                            onClick={() =>
                              handleOpenImageDialog(userData.collegeFeaturedUrl)
                            }
                          />
                          <Dialog
                            open={openImageDialog}
                        ...
                        >
                          <Grid sx={{ py: 20, px: 10 }}>
                            ...
                            >
                              ...
                              <DialogContent>
                                <Grid sx={{ width: "550px", height: "400px" }}>
                                  <img
                                    src={
                                      userData.collegeGallery[currentImageIndex]
                                        .imageUrl
                                    }
                                    alt="GalleryImage"
                                    style={{
                  ...
                  >
                    ...
                    <Button
                      ...
                      onClick={() =>
                        navigate(`/college-approval/college-approve-list`)
                      }
                    >
                      Cancel
                    </Button>
